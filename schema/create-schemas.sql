...
ALTER DATABASE lunt_energy SET search_path = public, electricity, electricity_iotawatt, electricity_statistics, electricity_cmp, electricity_plotting, oil, oil_statistics, oil_plotting, propane, propane_statistics, water, water_statistics, weather_data;
