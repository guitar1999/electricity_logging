...
plot(res$measurement_time, res$watts_water_pump, type='l', col='white', xlim=c(mintime, mintime + 7200), ylim=c(0,maxwatts), xlab="Time", ylab="Watts", main=paste("Well Pump Electricity Usage since ", mintime), xaxt='n', yaxt='n')
...
lines(res$measurement_time, res$watts_water_pump, col='steelblue', lwd=1.5)
