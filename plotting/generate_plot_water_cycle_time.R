...
plotmin <- floor(min(res$avg_cycle_time, res$rolling_avg_cycle_time_90d, res2$overall_avg_cycle_time, res$median_cycle_time, res$rolling_avg_cycle_time_median_90d, res$lifetime_median_cycle_time, na.rm=TRUE))
plotmax <- ceiling(max(res$avg_cycle_time, res$rolling_avg_cycle_time_90d, res2$overall_avg_cycle_time, res$median_cycle_time, res$rolling_avg_cycle_time_median_90d, res$lifetime_median_cycle_time, na.rm=TRUE))
