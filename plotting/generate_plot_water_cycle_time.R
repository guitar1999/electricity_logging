...
query <- "SELECT sum_date, avg_cycle_time, median_cycle_time, rolling_avg_cycle_time_7d, rolling_avg_cycle_time_30d, rolling_avg_cycle_time_90d, rolling_avg_cycle_time_median_90d FROM water_statistics.water_statistics_daily_cycle_view ORDER BY sum_date DESC LIMIT 90;"
...
plotmin <- floor(min(res$avg_cycle_time, res$rolling_avg_cycle_time_90d, res2$overall_avg_cycle_time))
plotmax <- ceiling(max(res$avg_cycle_time, res$rolling_avg_cycle_time_90d, res2$overall_avg_cycle_time))
...
axis(side=2, at=vseq, labels=vseq, las=1)
abline(h=vseq, col='grey', lty=3)
lines(res$sum_date, res$median_cycle_time, col='darkblue', lwd=3)
lines(res$sum_date, res$rolling_avg_cycle_time_median_90d, col='darkorange')
